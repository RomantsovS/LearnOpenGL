...
int main() {
    ...
    // -------------------------
    Shader shader("src/5.advanced_lighting/1.advanced_lighting/1.advanced_lighting.vs",
                  "src/5.advanced_lighting/1.advanced_lighting/1.advanced_lighting.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        std::cout << (enable ? "Blinn-Phong" : "Phong") << std::endl;
