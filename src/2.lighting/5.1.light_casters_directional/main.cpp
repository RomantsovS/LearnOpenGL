...
int main() {
    ...
    Shader lightingShader(
        "src/2.lighting/5.1.light_casters_directional/5.1.light_casters_directional.vs",
        "src/2.lighting/5.1.light_casters_directional/5.1.light_casters_directional.fs");
    Shader lightCubeShader("src/2.lighting/5.1.light_casters_directional/5.1.light_cube.vs",
                           "src/2.lighting/5.1.light_casters_directional/5.1.light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // float rad = 2.0f;
        // lightPos.x = std::sin((float)glfwGetTime()) * rad;
        // lightPos.y = std::cos((float)glfwGetTime() / 4) * rad;
        // lightPos.z = std::cos((float)glfwGetTime()) * rad;
