...
int main() {
    ...
    // ------------------------------------
    Shader lightingShader("src/2.lighting/5.2.light_casters_point/5.2.light_casters_point.vs",
                          "src/2.lighting/5.2.light_casters_point/5.2.light_casters_point.fs");
    Shader lightCubeShader("src/2.lighting/5.2.light_casters_point/5.2.light_cube.vs",
                           "src/2.lighting/5.2.light_casters_point/5.2.light_cube.fs");
