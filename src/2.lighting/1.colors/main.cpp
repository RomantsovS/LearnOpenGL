...
int main() {
    ...
    // ------------------------------------
    Shader lightingShader("src/2.lighting/1.colors/1.colors.vs",
                          "src/2.lighting/1.colors/1.colors.fs");
    Shader lightCubeShader("src/2.lighting/1.colors/1.light_cube.vs",
                           "src/2.lighting/1.colors/1.light_cube.fs");
