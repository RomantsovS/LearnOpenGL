...
int main() {
    ...
    // ------------------------------------
    Shader lightingShader("src/2.lighting/5.3.light_casters_spot/5.3.light_casters_spot.vs",
                          "src/2.lighting/5.3.light_casters_spot/5.3.light_casters_spot.fs");
    Shader lightCubeShader("src/2.lighting/5.3.light_casters_spot/5.3.light_cube.vs",
