...
int main() {
    ...
    // -------------------------
    Shader shader("src/4.advanced_opengl/5.1.framebuffers_exercise/5.1.framebuffers.vs",
                  "src/4.advanced_opengl/5.1.framebuffers_exercise/5.1.framebuffers.fs");
    Shader screenShader(
        "src/4.advanced_opengl/5.1.framebuffers_exercise/5.1.framebuffers_screen.vs",
        "src/4.advanced_opengl/5.1.framebuffers_exercise/5.1.framebuffers_screen.fs");
    ...
    float quadVertices[] = {
        ...
        // Coordinates.
        // positions   // texCoords
        -1.0f, 1.0f, 0.0f, 1.0f, -1.0f,  0.25f, 0.0f, 0.0f, -0.25f, 0.25f, 1.0f, 0.0f,

        -1.0f, 1.0f, 0.0f, 1.0f, -0.25f, 0.25f, 1.0f, 0.0f, -0.25f, 1.0f,  1.0f, 1.0f};
    // cube VAO
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        camera.ProcessMouseMovement(1800.0f, 0.0f);
        ...
        camera.ProcessMouseMovement(-1800, 0.0f);
