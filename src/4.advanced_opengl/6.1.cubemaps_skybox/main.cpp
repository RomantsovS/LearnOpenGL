...
int main() {
    ...
    // -------------------------
    Shader shader("src/4.advanced_opengl/6.1.cubemaps_skybox/6.1.cubemaps.vs",
                  "src/4.advanced_opengl/6.1.cubemaps_skybox/6.1.cubemaps.fs");
    Shader skyboxShader("src/4.advanced_opengl/6.1.cubemaps_skybox/6.1.skybox.vs",
                        "src/4.advanced_opengl/6.1.cubemaps_skybox/6.1.skybox.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        skyboxShader.use();
        view = glm::mat4(
            glm::mat3(camera.GetViewMatrix()));  // remove translation from the view matrix
