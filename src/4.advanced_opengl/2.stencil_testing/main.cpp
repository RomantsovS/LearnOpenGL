...
int main() {
    ...
    // -------------------------
    Shader shader("src/4.advanced_opengl/2.stencil_testing/2.stencil_testing.vs",
                  "src/4.advanced_opengl/2.stencil_testing/2.stencil_testing.fs");
    Shader shaderSingleColor("src/4.advanced_opengl/2.stencil_testing/2.stencil_testing.vs",
                             "src/4.advanced_opengl/2.stencil_testing/2.stencil_single_color.fs");
