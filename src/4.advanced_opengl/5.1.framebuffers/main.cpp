...
int main() {
    ...
    // -------------------------
    Shader shader("src/4.advanced_opengl/5.1.framebuffers/5.1.framebuffers.vs",
                  "src/4.advanced_opengl/5.1.framebuffers/5.1.framebuffers.fs");
    Shader screenShader("src/4.advanced_opengl/5.1.framebuffers/5.1.framebuffers_screen.vs",
                        "src/4.advanced_opengl/5.1.framebuffers/5.1.framebuffers_screen.fs");
