...
int main() {
    ...
    // ------------------------------------
    Shader ourShader("src/1.getting_started/6.1.coordinate_systems/6.1.coordinate_systems.vs",
                     "src/1.getting_started/6.1.coordinate_systems/6.1.coordinate_systems.fs");
