...
int main() {
    ...
    // ------------------------------------
    Shader ourShader("5_1_transformations/5.1.transform.vs",
                     "5_1_transformations/5.1.transform.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        float f = sin(glfwGetTime()) + 1.0f;
        transform = glm::translate(transform, glm::vec3(-0.5f, 0.5f, 0.0f));
        transform = glm::scale(transform, glm::vec3(f, f, 0.0f));
